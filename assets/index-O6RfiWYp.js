...
expedita consequatur consequatur dolores quia eos et placeat`}],Dc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],jc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}];function tm(e){return jc.filter(t=>t.id===e)||null}const im=Dc.map(e=>({...e,user:tm(e.userId)})),Oc=Rc.map(e=>({...e,user:tm(e.userId),comments:im.filter(t=>t.postId===e.id)})),Fc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Tc,{posts:Oc,comments:im})]});em(document.getElementById("root")).render(j.jsx(Fc,{}));
